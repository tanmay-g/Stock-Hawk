...
public class StockTaskService extends GcmTaskService{
    ...
    final static int INVALID_STOCK_NAME = -5;
    final static int NETWORK_FAILURE = GcmNetworkManager.RESULT_FAILURE;
    final static int NETWORK_SUCCESS = GcmNetworkManager.RESULT_SUCCESS;
    ...
    public int onRunTask(TaskParams params){
        ...
        if (urlStringBuilder != null){
            ...
            try{
                Log.i(LOG_TAG, "Requesting: " + urlString);
...
//                }
                try {
                    ...
                    Log.e(LOG_TAG, "Got random error response");
                    result = NETWORK_FAILURE;
                }
            } catch (IOException e){
                e.printStackTrace();
